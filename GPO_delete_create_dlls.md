...
000-MH-Global-Microsoft Defender for Identity Enforced 
000-CORP-DisableSMBv1Client Enforced 
923-CORP-ServiceNow_ACCAgent Enforced 
000-MH-Password_Policy Enforced 
...
Domain corp.mann-hummel.com 
Site DE-Frankfurt 
Organizational Unit corp.mann-hummel.com/_Admin/Tier0/T0-Servers 
...
Enforce password history 20 passwords remembered 000-MH-Password_Policy 
Maximum password age 180 days 000-MH-Password_Policy 
Minimum password age 1 days 000-MH-Password_Policy 
Minimum password length 12 characters 000-MH-Password_Policy 
Password must meet complexity requirements Enabled 000-MH-Password_Policy 
...
Account lockout duration 10 minutes 000-MH-Password_Policy 
Account lockout threshold 5 invalid logon attempts 000-MH-Password_Policy 
Reset account lockout counter after 10 minutes 000-MH-Password_Policy 
...
Accounts: Limit local account use of blank passwords to console logon only Enabled 910-MH-Server-Hardening 
...
Domain member: Digitally encrypt or sign secure channel data (always) Enabled 910-MH-Server-Hardening 
Domain member: Digitally encrypt secure channel data (when possible) Enabled 910-MH-Server-Hardening 
Domain member: Require strong (Windows 2000 or later) session key Enabled 910-MH-Server-Hardening 
...
Interactive logon: Smart card removal behavior Lock Workstation 910-MH-Server-Hardening 
...
Microsoft network server: Digitally sign communications (always) Enabled 910-MH-Server-Hardening 
...
Network access: Allow anonymous SID/Name translation Disabled 910-MH-Server-Hardening 
Network access: Do not allow anonymous enumeration of SAM accounts and shares Enabled 910-MH-Server-Hardening 
...
Network security: Do not store LAN Manager hash value on next password change Enabled 000-MH-Password_Policy 
...
Network security: LDAP client signing requirements Negotiate signing 910-MH-Server-Hardening 
Network security: Minimum session security for NTLM SSP based (including secure RPC) clients Enabled 910-MH-Server-Hardening 

Require NTLMv2 session security Enabled 
Require 128-bit encryption Enabled 
 
Network security: Minimum session security for NTLM SSP based (including secure RPC) servers Enabled 910-MH-Server-Hardening 
...
User Account Control: Admin Approval Mode for the Built-in Administrator account Enabled 910-MH-Server-Hardening 
User Account Control: Behavior of the elevation prompt for administrators in Admin Approval Mode Prompt for consent on the secure desktop 910-MH-Server-Hardening 
User Account Control: Behavior of the elevation prompt for standard users Automatically deny elevation requests 910-MH-Server-Hardening 
User Account Control: Detect application installations and prompt for elevation Enabled 910-MH-Server-Hardening 
User Account Control: Only elevate executables that are signed and validated Enabled 910-MH-Server-Hardening 
User Account Control: Virtualize file and registry write failures to per-user locations Enabled 910-MH-Server-Hardening 
...
Network access: Restrict clients allowed to make remote calls to SAM O:BAG:BAD:(A;;RC;;;BA)(A;;RC;;;S-1-5-21-1935655697-362288127-725345543-27627) 000-MH-Global-Microsoft Defender for Identity 
Network security: Allow LocalSystem NULL session fallback Enabled 910-MH-Server-Hardening 
...
Winning GPO 910-MH-Server-Hardening 
...
Policy version 2.26 910-MH-Server-Hardening 
...
Firewall state On 910-MH-Server-Hardening 
...
Log dropped packets Yes 910-MH-Server-Hardening 
Log successful connections Yes 910-MH-Server-Hardening 
Log file path %systemroot%\system32\logfiles\firewall\pfirewall.log 910-MH-Server-Hardening 
Log file maximum size (KB) 4096 910-MH-Server-Hardening 
...
Windows Remote Management (HTTP-In) Inbound rule for Windows Remote Management via WS-Management. [TCP 5985] 910-MH-Server-Hardening 
...
DataProtector  910-MH-Server-Hardening 
...
Audit Credential Validation Success, Failure 910-MH-Server-Hardening 
...
Audit Security Group Management Success 910-MH-Server-Hardening 
Audit User Account Management Success, Failure 910-MH-Server-Hardening 
...
Audit PNP Activity Success 910-MH-Server-Hardening 
Audit Process Creation Success 910-MH-Server-Hardening 
...
Audit Account Lockout Success, Failure 910-MH-Server-Hardening 
Audit Group Membership Success 910-MH-Server-Hardening 
Audit Logon Success, Failure 910-MH-Server-Hardening 
Audit Special Logon Success 910-MH-Server-Hardening 
...
Audit Detailed File Share Failure 910-MH-Server-Hardening 
Audit File Share Success, Failure 910-MH-Server-Hardening 
Audit Other Object Access Events Success, Failure 910-MH-Server-Hardening 
Audit Removable Storage Success, Failure 910-MH-Server-Hardening 
...
Audit Audit Policy Change Success 910-MH-Server-Hardening 
Audit Other Policy Change Events Success, Failure 910-MH-Server-Hardening 
...
Audit Sensitive Privilege Use Success, Failure 910-MH-Server-Hardening 
...
Audit Other System Events Success, Failure 910-MH-Server-Hardening 
Audit Security State Change Success 910-MH-Server-Hardening 
Audit Security System Extension Success 910-MH-Server-Hardening 
Audit System Integrity Success, Failure 910-MH-Server-Hardening 
...
Do not allow password expiration time longer than required by policy Enabled 910-MH-Server-Hardening 
Enable local admin password management Enabled 910-MH-Server-Hardening 
Password Settings Enabled 910-MH-Server-Hardening 
...
Type the name of the hosted cache server DFS-DE-HUB-1.mh.corp.mann-hummel.com 
...
Turn off multicast name resolution Enabled 910-MH-Server-Hardening 
...
Windows Defender Firewall: Allow ICMP exceptions Enabled 910-MH-Server-Hardening 
...
Windows Defender Firewall: Allow inbound remote administration exception  Enabled 910-MH-Server-Hardening 
...
Windows Defender Firewall: Allow logging Enabled 910-MH-Server-Hardening 
...
Windows Defender Firewall: Protect all network connections Enabled 910-MH-Server-Hardening 
...
Windows Defender Firewall: Allow inbound Remote Desktop exceptions Enabled 910-MH-Server-Hardening 
...
PC-UA-KRA-8220.mh.corp.mann-hummel.com 920-DE-LB-DFSBrancheCache 
PC-PL-GOS-869.mh.corp.mann-hummel.com 920-DE-LB-DFSBrancheCache 
ps-cz-ok-2.mh.corp.mann-hummel.com 920-DE-LB-DFSBrancheCache 
PS-DE-MK-1.mkfn.de.corp.mann-hummel.com 920-DE-LB-DFSBrancheCache 
Prncl.de.corp.mann-hummel.com 920-DE-LB-DFSBrancheCache 
prn-de-hub-1.mh.corp.mann-hummel.com 920-DE-LB-DFSBrancheCache 
ps-cz-ok-1.mh.corp.mann-hummel.com 920-DE-LB-DFSBrancheCache 
PS-DE-MK-2.mkfn.de.corp.mann-hummel.com 920-DE-LB-DFSBrancheCache 
PC-UA-KRA-8213.mh.corp.mann-hummel.com 920-DE-LB-DFSBrancheCache 
...
FS-UA-KRA-1.mh.corp.mann-hummel.com 920-DE-LB-DFSBrancheCache 
ps-cz-ok-2.cz.corp.mann-hummel.com 920-DE-LB-DFSBrancheCache 
PC-UA-KRA-8208.mh.corp.mann-hummel.com 920-DE-LB-DFSBrancheCache 
pc-cz-ok-8006.mh.corp.mann-hummel.com 920-DE-LB-DFSBrancheCache 
ps-es-za-1.mh.corp.mann-hummel.com 920-DE-LB-DFSBrancheCache 
testmt-de-hub-1.de.corp.mann-hummel.com 920-DE-LB-DFSBrancheCache 
pc-cz-ok-9002 920-DE-LB-DFSBrancheCache 
PC-UA-KRA-8215.mh.corp.mann-hummel.com 920-DE-LB-DFSBrancheCache 
PS-DE-MK-1 920-DE-LB-DFSBrancheCache 
fs-de-hub-5.mh.corp.mann-hummel.com 920-DE-LB-DFSBrancheCache 
PC-UA-KRA-8213 920-DE-LB-DFSBrancheCache 
PC-UA-KRA-8215 920-DE-LB-DFSBrancheCache 
ps-es-za-2.es.corp.mann-hummel.com 920-DE-LB-DFSBrancheCache 
pc-cz-ok-23027.mh.corp.mann-hummel.com 920-DE-LB-DFSBrancheCache 
PC-UA-KRA-8221 920-DE-LB-DFSBrancheCache 
PC-PL-GOS-867.mh.corp.mann-hummel.com 920-DE-LB-DFSBrancheCache 
PC-UA-KRA-8221.mh.corp.mann-hummel.com 920-DE-LB-DFSBrancheCache 
prn-de-3.de.corp.mann-hummel.com 920-DE-LB-DFSBrancheCache 
...
ps-pl-gos-1.mh.corp.mann-hummel.com 920-DE-LB-DFSBrancheCache 
PC-UA-KRA-8210.mh.corp.mann-hummel.com 920-DE-LB-DFSBrancheCache 
ps-cz-ok-1 920-DE-LB-DFSBrancheCache 
pc-cz-ok-9022.cz.corp.mann-hummel.com 920-DE-LB-DFSBrancheCache 
pc-cz-ok-23023.mh.corp.mann-hummel.com 920-DE-LB-DFSBrancheCache 
Turn off Autoplay Enabled 910-MH-Server-Hardening 
...
Specify the maximum log file size (KB) Enabled 910-MH-Server-Hardening 
...
Do not allow client printer redirection Enabled 910-MH-Server-Hardening 
...
Always prompt for password upon connection Enabled 910-MH-Server-Hardening 
Require secure RPC communication Enabled 910-MH-Server-Hardening 
Set client connection encryption level Enabled 910-MH-Server-Hardening 
...
Set time limit for disconnected sessions Enabled 910-MH-Server-Hardening 
...
Sign-in and lock last interactive user automatically after a restart Disabled 910-MH-Server-Hardening 
...
Turn on Module Logging Enabled 910-MH-Server-Hardening 
...
Turn on PowerShell Script Block Logging Enabled 910-MH-Server-Hardening 
...
Allow Basic authentication Disabled 910-MH-Server-Hardening 
Allow unencrypted traffic Disabled 910-MH-Server-Hardening 
Disallow Digest authentication Enabled 910-MH-Server-Hardening 
...
Allow Basic authentication Disabled 910-MH-Server-Hardening 
Allow remote server management through WinRM Enabled 910-MH-Server-Hardening 
...
Allow unencrypted traffic Disabled 910-MH-Server-Hardening 
Disallow WinRM from storing RunAs credentials Enabled 910-MH-Server-Hardening 
...
Configure Automatic Updates Enabled 910-MH-Servers-WSUS 
...
Enable client-side targeting Enabled 910-MH-Servers-WSUS 
...
Specify intranet Microsoft update service location Enabled 910-MH-Servers-WSUS 

Set the intranet update service for detecting updates: https://wsust1-de-hub-1.mh.corp.mann-hummel.com:8531 
Set the intranet statistics server: https://wsust1-de-hub-1.mh.corp.mann-hummel.com:8531 
...
Action Replace 
Properties
Source file(s) \\corp.mann-hummel.com\SYSVOL\corp.mann-hummel.com\scripts\ServiceNowAgent\AccAgentSettings.json 
...
Action Replace 
Properties
Source file(s) \\corp.mann-hummel.com\SYSVOL\corp.mann-hummel.com\scripts\ServiceNowAgent\Invoke-SNAgentClientCollectorInstallation.ps1 
...
Action Replace 
Properties
Source file(s) \\toinv-corp-1.corp.mann-hummel.com\2Inv-Install\Dash-File-Dist_Bootstrapper.ps1 
...
Action Replace 
Properties
Source file(s) \\corp.mann-hummel.com\SYSVOL\corp.mann-hummel.com\scripts\ServiceNowAgent\check-allow-list.json 
...
Action Replace 
Properties
Source file(s) \\corp.mann-hummel.com\SYSVOL\corp.mann-hummel.com\scripts\ServiceNowAgent\Set-SNAgentClientCollectorConfiguration.ps1 
...
Scheduled Task (At least Windows 7) (Name: MH_ServiceNowAgent_Configuration)


The following settings have applied to this object. Within this category, settings nearest the top of the report are the prevailing settings when resolving conflicts.

MH_ServiceNowAgent_Configuration
...
Action Replace 
Task
 Name  MH_ServiceNowAgent_Configuration   
...
Scheduled Task (At least Windows 7) (Name: MH_Set-JEA-ServiceNow)


The following settings have applied to this object. Within this category, settings nearest the top of the report are the prevailing settings when resolving conflicts.

MH_Set-JEA-ServiceNow
...
Action Replace 
Task
 Name  MH_Set-JEA-ServiceNow   
 Author  MH\lbextvburkhardta   
...
1. Start a program     
 ...
 Arguments  -NonInteractive -Executionpolicy Bypass -File "\\mh.corp.mann-hummel.com\dfs\CentralIT-Automation\SNow-JEA\Set_ServiceNOW_JEA_PSSessionConfig_signed.ps1"   
Settings
 Stop if the computer ceases to be idle  No   
 Restart if the idle state resumes  No   
 Start the task only if the computer is on AC power  No   
...
Scheduled Task (At least Windows 7) (Name: MH_IcingaForWindows_Deployment)


The following settings have applied to this object. Within this category, settings nearest the top of the report are the prevailing settings when resolving conflicts.

MH_IcingaForWindows_Deployment
...
Action Replace 
Task
 Name  MH_IcingaForWindows_Deployment   
 Author  Andi Bellstedt   
...
Scheduled Task (At least Windows 7) (Name: MH_SNOWInventoryAgent_Removal)


The following settings have applied to this object. Within this category, settings nearest the top of the report are the prevailing settings when resolving conflicts.

MH_SNOWInventoryAgent_Removal
...
Action Replace 
Task
 Name  MH_SNOWInventoryAgent_Removal   
 Author  Andi Bellstedt   
...
Scheduled Task (At least Windows 7) (Name: MH_ServiceNowAgent_Deployment_EMEA)


The following settings have applied to this object. Within this category, settings nearest the top of the report are the prevailing settings when resolving conflicts.

MH_ServiceNowAgent_Deployment_EMEA
...
Action Replace 
Task
 Name  MH_ServiceNowAgent_Deployment_EMEA   
 Author  Andi Bellstedt   
...
1. Start a program     
 Program/script  C:\Windows\System32\WindowsPowerShell\v1.0\powershell.exe   
 Arguments  -ExecutionPolicy RemoteSigned -command "& {C:\sw-depot\ServiceNowAgent\Invoke-SNAgentClientCollectorInstallation.ps1 -AdditionalInstallerArguments '/norestart ACC_API_KEY=a4326d9e47dc9190e6b349bd436d4375 ACC_MID=wss://SNowMID-DE-HUB.mh.corp.mann-hummel.com:8085/ws/events'-ServiceAccountNameDC 'CORP\GSVC-ServiceN0w$';if($error){exit 1}}"   
 Start in  c:\sw-depot\ServiceNowAgent   
Settings
 Stop if the computer ceases to be idle  No   
 Restart if the idle state resumes  No   
...
Link Location corp.mann-hummel.com 
...
000-MH-Global-Microsoft Defender for Identity [{EE4F622B-8988-4D60-94A8-B20489B01328}]
...
WMI Filter OS Windows Server after 2012R2 (mh.corp.mann-hummel.com) 

000-MH-Password_Policy [{DC0CD7F3-E38A-4B67-8FBC-6AE0A3BFD0AF}]
...
Link Location corp.mann-hummel.com/_Admin/Tier0/T0-Servers 
...
910-MH-Server-Hardening [{01ED9C71-5575-48A1-93B1-FA175B0E73F7}]
...
910-MH-Servers-WSUS [{150A51CE-E7F6-49CA-81FB-5C6BDC9A4D3B}]
...
Link Location corp.mann-hummel.com/Configuration/Sites/DE-Frankfurt 
Extensions Configured Group Policy Registry
Registry
Group Policy Infrastructure 
Enforced No 
...
971-MH-2Inv [{685C9F47-7E0F-4830-B4B6-9D7019E230AF}]
...
972-CORP-CustomPowerShellProfile_MHPSGallery_Tier0_and_DC [{BFE4311B-4986-4574-95CF-5360A5447F29}]
...
OS Windows Server after 2012R2 (mh.corp.mann-hummel.com) True 000-MH-Global-Microsoft Defender for Identity 
...
User name MH\XDELB00958a 
Domain mh.corp.mann-hummel.com 
Organizational Unit mh.corp.mann-hummel.com/_Admin/Tier1/T1-Accounts 
Security Group Membership 
show 
